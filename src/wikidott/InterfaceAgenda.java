...
public class InterfaceAgenda extends JInternalFrame {
	...
	public InterfaceAgenda() {
		...
		buttonRemover.setIcon(new ImageIcon(getClass().getResource("imagens/REMOVER.png")));
	...
	private void buttonRemoverActionPerformed(ActionEvent e) {
		...
		int resposta = JOptionPane.showConfirmDialog(this, "Deseja remover registro?", "Remoção",
		...
		if (resposta == JOptionPane.OK_OPTION) {
			...
			if (linha < 0)
				...
				JOptionPane.showMessageDialog(this, "Registro excluído com sucesso!!!", "Remover",
	...
	public void preencheTabela() {
		...
		while (it.hasNext()) {
			...
			modelo.addRow(new String[] { p.getCodigo(), p.getNome(), p.getTelefone(), p.getEmail(), p.getEndereco() });
		}
	}
